...
public class PaymentTooLowDialog {
    ...
    public void showUnderpayment(final long paymentAmountInSatoshis, Long expectedAmountInSatoshis,
        ...
        sb.append(context.getText(R.string.insufficient_payment));
        sb.append("\n");
        sb.append(context.getText(R.string.re_payment_requested));
        sb.append(" ");
        AmountUtil f = new AmountUtil(context);
        sb.append(f.formatBch(bchExpectedAmount));
        sb.append("\n");
        sb.append(context.getText(R.string.re_payment_received));
        sb.append(" ");
        sb.append(f.formatBch(bchPaymentAmount));
        sb.append("\n");
        sb.append(context.getText(R.string.re_payment_remainder));
        sb.append(" ");
        ...
        sb.append("\n");
        sb.append(context.getText(R.string.insufficient_payment_continue));
